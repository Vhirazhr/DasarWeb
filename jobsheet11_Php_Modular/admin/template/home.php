<div class="container-fluid">
    <div class="row">
        <?php
        include 'C:\laragon\www\dasarweb\jobsheet11_Php_Modular\config';

        if (!$koneksi) {
            die("Koneksi database gagal: " . mysqli_connect_error());
        }
        $username = 'admin';
        $password = '$2y$10$NcNfHE82FUSlqmvcjug0Pe1yB72.g3Sxy4mHHPQRkq0nUrRFaCrIO';
        $salt = '8ad2e053c563c20a803cf4698d95bf9d';
        $hashed_password = md5($password . $salt); 
        
        $query = "INSERT INTO user (username, password, salt, level) VALUES ('$username', '$hashed_password', '$salt', 'admin')";
